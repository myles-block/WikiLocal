...
def test_title_date_non_empty(backend):
    ''' testing title_date method for valid [list of title ,upvote and downvote] and date_creted stored in dictionary 
...
def test_title_date_empty(backend):
    ''' testing title_date method for valid [list of title ,upvote and downvote] and date_creted stored in dictionary 
